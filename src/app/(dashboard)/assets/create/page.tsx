  ...
  return (
    <div className="space-y-6 animate-fade-in">
        <div className="flex items-center gap-2 text-sm text-muted-foreground">
            ...
            <span className="text-foreground">Create New Asset</span>
        </div>
      ...
      <div className="space-y-8">
        <FormSection title="Data offer type" description="Define the type of your offer">
            <FormField>
                ...
                <RadioGroup defaultValue="available" onValueChange={setOfferType}>
        ...
        <FormSection title="General Information" description="Fill out general information about the asset.">
            <FormField>
