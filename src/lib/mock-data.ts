...
export const users = [
  {
    id: 'usr01',
    name: 'Adi Prasetyo',
    email: 'adi.prasetyo@skkmigas.go.id',
    role: 'Regulator (SKK Migas)',
  ...
  },
  {
    id: 'usr03',
    name: 'Citra Dewi',
    email: 'citra.dewi@medcoenergi.com',
    role: 'Data Custodian',
    organization: 'MEDCO',
  ...
  },
  {
    id: 'usr04',
    name: 'Dian Lestari',
    email: 'dian.lestari@inpex.co.jp',
  ...
  },
  {
  ...
  },
   {
    id: 'usr07',
    name: 'Gilang Pratama',
    email: 'gilang.p@externalvendor.com',
